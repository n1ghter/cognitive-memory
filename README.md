...
- **Local Embeddings**: Integrates directly with Ollama (`nomic-embed-text`) to generate 768-dimensional embeddings without hitting external APIs.
...
- `pnpm`
- Ollama (running locally on port `11434` with the `nomic-embed-text` and `llama3.2` models)
